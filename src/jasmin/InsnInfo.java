...
class InsnInfo {
    ...
    static {
        ...
        addInfo("goto", RuntimeConstants.opc_goto, "label,offset");
        addInfo("goto_w", RuntimeConstants.opc_goto_w, "label,offset");
        ...
        addInfo("if_acmpeq", RuntimeConstants.opc_if_acmpeq, "label,offset");
        addInfo("if_acmpne", RuntimeConstants.opc_if_acmpne, "label,offset");
        addInfo("if_icmpeq", RuntimeConstants.opc_if_icmpeq, "label,offset");
        addInfo("if_icmpge", RuntimeConstants.opc_if_icmpge, "label,offset");
        addInfo("if_icmpgt", RuntimeConstants.opc_if_icmpgt, "label,offset");
        addInfo("if_icmple", RuntimeConstants.opc_if_icmple, "label,offset");
        addInfo("if_icmplt", RuntimeConstants.opc_if_icmplt, "label,offset");
        addInfo("if_icmpne", RuntimeConstants.opc_if_icmpne, "label,offset");
        addInfo("ifeq", RuntimeConstants.opc_ifeq, "label,offset");
        addInfo("ifge", RuntimeConstants.opc_ifge, "label,offset");
        addInfo("ifgt", RuntimeConstants.opc_ifgt, "label,offset");
        addInfo("ifle", RuntimeConstants.opc_ifle, "label,offset");
        addInfo("iflt", RuntimeConstants.opc_iflt, "label,offset");
        addInfo("ifne", RuntimeConstants.opc_ifne, "label,offset");
        addInfo("ifnonnull", RuntimeConstants.opc_ifnonnull, "label,offset");
        addInfo("ifnull", RuntimeConstants.opc_ifnull, "label,offset");
        ...
        addInfo("jsr", RuntimeConstants.opc_jsr, "label,offset");
        addInfo("jsr_w", RuntimeConstants.opc_jsr, "label,offset");  // synonym for "jsr"
